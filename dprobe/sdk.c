	...
	)
{
	...
	Font.lfHeight = 8;
	Font.lfWidth = 8;
	wsprintf(Font.lfFaceName, L"%ws", L"System");
	
	return CreateFont(Font.lfHeight, Font.lfWidth, Font.lfEscapement, Font.lfOrientation, 
					  Font.lfWeight, Font.lfItalic, Font.lfUnderline, Font.lfStrikeOut, 
					  Font.lfCharSet, Font.lfOutPrecision, Font.lfClipPrecision, Font.lfQuality,
